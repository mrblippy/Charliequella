...
public class CanvasIntegration extends AbstractIntegrationService<CanvasSessionData> {
  ...
  public void setupCache() {
    courseStructureCache =
        cacheService.getCache("CanvasSignonCourseStructure", 100, 2, TimeUnit.MINUTES);
  }
  ...
  public void setupSingleSignOn(SectionInfo info, SingleSignonForm form) {
    ...
    data.setCourseInfoCode(
        integrationService.getCourseInfoCode(courseId, courseCodes.toArray(new String[] {})));
  ...
  public SelectionSession setupSelectionSession(
      SectionInfo info, CanvasSessionData data, SelectionSession session, SingleSignonForm form) {
  ...
  private String initStructure(
      CanvasSessionData data, SelectionSession session, SingleSignonForm form) {
